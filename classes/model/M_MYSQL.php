...
class M_MYSQL extends mysqli
{
    ...
    //TODO дамп базы реализовать иначе
    // создание БД
    private function create_db(){
        $sql = "CREATE DATABASE malkov_db";
        $this->query($sql);
    }
